...
Ds = np.array([[600 * 10**-6], [354 * 10**-6], [177 * 10**-6], [100 * 10**-6],
               [70 * 10**-6],
               [30 * 10**-6]])  # representative diameters of grain-size classes
...
def plot_result(C, deposit):
    ...
    plt.legend(prop=fp,
               ...
               loc='upper left',
               borderaxespad=0)
    plt.savefig('../FITTNUSS-forward_training_DNN/Forward_g6_300_17_06.eps')
    plt.show()
...
read_setfile("config_g6_300grid.ini")
(x, C, spoints, deposit) = forward([4000, 3.0, 4.5, 0.01, 0.01, 0.01, 0.01,0.01,0.01])
#ipdb.set_trace()
...
if __name__ == "__main__":
    ...
    read_setfile("config_g6_300grid_19_11_case2.ini")
    number_of_training_data = 5000
    
    Rw=np.random.uniform(2500,4500,number_of_training_data)
    U0=np.random.uniform(1.5,10,number_of_training_data)
    ...
    np.savetxt("start_param_random_5000_g6_300grid_19_11.csv", a, delimiter=",")
    params=np.loadtxt('start_param_random_5000_g6_300grid_19_11.csv', delimiter=',')
    ...
    np.savetxt('eta_5000_g6_300grid_19_11.csv', eta, delimiter=',')
...
import numpy as np
icond = np.loadtxt('start_param_random_5000_g6_300grid_19_11.csv', delimiter=',')
#icond_new=icond[:,1:]
...
print(icond.shape)
eta = np.loadtxt('eta_5000_g6_300grid_19_11.csv', delimiter=',')
